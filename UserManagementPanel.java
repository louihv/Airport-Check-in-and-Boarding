...
public class UserManagementPanel extends JPanel {
    ...
    public UserManagementPanel() {
        ...
        JLabel leftTitle = new JLabel("Register New User");
        ...
        JTextField txtUser = createOutlineField();
        JPasswordField txtPass = createOutlinePassword();
        JComboBox<String> cmbRole = new JComboBox<>(new String[]{"STAFF", "ADMIN"});
        styleCombo(cmbRole);
        JTextField txtCounter = createOutlineField();
        ...
        JButton btnRegister = createFilledButton("Register");
        ...
        btnRefresh = createOutlineButton("Refresh Users");
